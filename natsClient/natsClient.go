// copied from https://github.com/starkandwayne/nats/blob/master/nats.go
package natsclient
...
var subMessage = "Usage: nats sub [-s server url] [--ssl] [-t] <subject> \n" +
	"example nats sub -s http://nats:c1tp5z1t1jbaytphahd4@10.244.0.129:4222 router.*"
